...
-----------------------------------
OBS: SE DER ERRO AO FAZER O TESTES (npm test),  jest.config.js para outro nome, exclua o arquivo jest.config.js

------
ERRO que tive ao tentar submeter o desafio da Codenation (AceleraDev);
 - O Jest não foi encontrado

SOLUÇÃO:
subir o código através do CMD (Prompt de Comando) com permissão de Administração
